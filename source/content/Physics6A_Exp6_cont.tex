...
%	\itm {{\bf Just tell them the model is linear}}
	\itm {{\bf Don't be afraid to tell them the model is linear
		in the instructions for the sake of clarity.
		They'll be expecting it to be linear anyway.}}
	\itm That being said, don't give it away too explicitly,
		especially before they have to extract a `formula' from their data.
	\itm Include some instructions about how to measure the angle,
		even if it's just an adendum.
}
...
the concepts of torque explored in the warmup probelms? 
Why or why not?
...
%as well as on the slope and the \yint  of the graph.}
...
\TODO{Subtelty -- three types of experimental parameters:  
	...
	In this case, $r,R,W$, and angle of the biceps force are type (2), 
...
%regarding how the biceps force changes when
