...
%    \newcommand{\vect}[1]{\boldsymbol{#1}}
    ...
    \newcommand{\unittemp}[1]{\,\widehat{ \boldsymbol{#1} }}
    ...
    \newcommand{\basis}[1]{ \,\unittemp{\mathrm{e}}_{ #1 } }
    \newcommand{\q}[1]{q_{#1}}
    \newcommand{\bq}[1]{\,\unittemp{\mathrm{q}}_{#1}}
...
\newcommand{\mycolor}[2]{\begin{mycolorenv}{#1}#2\end{mycolorenv}}
